...
export default function EditStudent() {
    ...
    const loadUser = async () => {
        try {
            const result = await axios.get(`http://ec2-13-127-25-66.ap-south-1.compute.amazonaws.com/api/s/getstudent/${id}`);
    ...
    const updateStudent = async () => {
        ...
        try {
            ...
            // setStudent(result.data);
            await axios.put(`http://ec2-13-127-25-66.ap-south-1.compute.amazonaws.com/api/s/updatestudent/${id}`, student);
        } catch (error) {
