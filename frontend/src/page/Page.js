...
export default function Page() {
    ...
    const loadStudents = async () => {
        try {
            const response = await axios.get("http://ec2-13-127-128-170.ap-south-1.compute.amazonaws.com/api/s/getallstudent");
    ...
    const delteStudent = async (id) => {
        try {
          await axios.delete(`http://ec2-13-127-128-170.ap-south-1.compute.amazonaws.com/api/s/deletestudent/${id}`);
          loadStudents();
        } catch (error) {
